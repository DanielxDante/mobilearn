...
const PaymentOptions: React.FC<PaymentOptionsProps> = ({ selectedMethod, onSelectMethod }) => {
  return (
    <View>
      {
        paymentData.map((method) => (
          ...
          >
            <View style={styles.radioContainer}>
              <View style={[styles.radioCircle, selectedMethod === method.id && styles.selectedCircle]} />
            </View>
