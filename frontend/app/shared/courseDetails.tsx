...
const CourseDetails = () => {
    ...
    const skills = ["Typography", "Layout Composition", "Branding", "Visual communication", "Editorial design"];
                ...
                <View style={styles.container}>
                    ...
                    <View>
                        ...
                        <View style={styles.skillsContainer}>
                            {skills.map((skill, index) => (
                                <TouchableOpacity key={index} style={styles.skillButton} onPress={() => handleSkillPress(skill)}>
                    ...
                    <View>
                        <TouchableOpacity style={styles.enrollNowButton}>
                            <Text style={styles.enrollNowButtonText}>{Constants.enrollNowButton}</Text>
                        </TouchableOpacity>
                    </View>
                </View>
            </ScrollView>
