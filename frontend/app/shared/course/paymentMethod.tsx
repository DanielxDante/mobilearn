    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView>
        ...
        <View style={styles.titleView}>
          <Text style={styles.title}>{t("paymentMethodConstants.title")}</Text>
        </View>
        {/* Payment types */}
        ...
        <View style={styles.priceContainer}>
          <View style={styles.priceContainerLeft}>
            ...
            <Text style={styles.totalPrice}>
              {"  "}
              {t("paymentMethodConstants.totalPrice")}
            </Text>
          </View>
          <Text style={styles.totalPrice}>
            {price}
            {t("paymentMethodConstants.currency")}
          </Text>
        </View>
        {/* Horizontal line */}
        ...
        >
          <Text style={styles.continueText}>
            {t("paymentMethodConstants.continueButton")}
          </Text>
        </TouchableOpacity>
      </ScrollView>
    </SafeAreaView>
