...
const CommunityPage = () => {
    ...
    useEffect(() => {
        const getCommunity = async () => {
            ...
            const community = communityData.find((community: any) => community.name === communityName)
            if (community) {
            ...
            <ScrollView>
                <View style={styles.body}>
                    ...
                    <View style={styles.headerContainer}>
                        <Image source={{uri: communityLogo}} style={styles.communityLogo}/>
                    ...
                    <View style={styles.instructorsContainer}>
                        <Text style={styles.instructorsTitle}>{Constants.instructors}</Text>
                    </View>
                    {
                        instructorData?.map((instructor) => (
                            <View style={styles.instructorContainer} key={instructor.instructor_id}>
                                <View style={styles.profilePicContainer}>
                                    {
                                        (instructor.instructor_profile_picture) ? (
                                            <Image source={{uri: instructor.instructor_profile_picture}} style={styles.profilePic}/>
                                        ) : (
