...
const PrivateChatDetails = () => {
    ...
    useEffect(() => {
            const fetchChatInfo = async () => {
                ...
                const emailTemp = chat_info.participants.find((participant: any) => participant.participant_name === chat_info.chat_name)?.participant_email
                if (emailTemp) {
                    setEmail(emailTemp);
                }
            }
            ...
            <ScrollView>
                <View style={styles.body}>
                    ...
                    <View style={styles.emailView}>
                        <Text>{Constants.email}{email}</Text>
                    </View>
                </View>
            </ScrollView>
        </SafeAreaView>
