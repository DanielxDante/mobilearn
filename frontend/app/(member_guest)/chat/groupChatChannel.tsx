...
const MsgBubble: React.FC<MsgBubbleProps> = ({ 
        ...
        const otherParticipant = participant_list.find(
            (participant) => (participant.id === chat_participant_id) && 
            (participant.id !== self_participant_id)
        );
        const otherParticipantName = otherParticipant? otherParticipant.name : undefined;
...
const GroupChatChannel = () => {
    ...
    useEffect(() => {
        const fetchChatInfo = async () => {
            ...
            const participantList = chat_info.participants.map((participant: any) => ({
