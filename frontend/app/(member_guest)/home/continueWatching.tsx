...
const ContinueWatching: React.FC<ContinueWatchingProps> = ({ onSelect }) => {
            ...
            <View style={styles.progressContainer}>
              ...
              <View style={styles.progressTextContainer}>
                <Text style={styles.progressText}>
                  ...
                  {t("memberGuestContinueWatchingConstants.completionRateText")}
                </Text>
              </View>
            </View>
          ) : null}
      ...
      {courses?.length > 0 && (
        <>
          <Text style={styles.headerText}>
            {t("memberGuestContinueWatchingConstants.continueWatchingSubtitle")}
          </Text>
