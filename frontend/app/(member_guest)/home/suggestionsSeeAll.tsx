...
const SuggestionsSeeAll = () => {
  ...
  const recommendedCourses = useAppStore((state) => state.recommended_courses);
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.appBarContainer}>
        ...
        <Text style={styles.suggestionsHeader}>
          {t("memberGuestSuggestionsSeeAll.appBarTitle")}
        </Text>
      </View>
        ...
        >
          ...
          {loading && (
            <Text style={styles.loadingText}>
              {t("memberGuestSuggestionsSeeAll.loading")}
            </Text>
          )}
          {!hasMore && (
            <Text style={styles.endText}>
              {t("memberGuestSuggestionsSeeAll.endText")}
            </Text>
          )}
        </ScrollView>
      </View>
